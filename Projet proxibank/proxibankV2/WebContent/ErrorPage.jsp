...
<html lang="fr">
  <head>
    ...
    <link href="https://stackpath.bootstrapcdn.com/bootswatch/4.1.3/cosmo/bootstrap.min.css" rel="stylesheet" integrity="sha384-3Ivskwia8Fui5tbQi+RW4DgTkJ8d+hW7mLe7Yk89ibmD9482VECh0WFof8kIEjwI" crossorigin="anonymous">
      <link rel="stylesheet" href="inc/css/banqueStyle.css">
  </head>

  <body>
    <div class="container">
      <div class="jumbotron mt-3">
        <h1>Desolé une erreur à été detecter</h1>
        <a class="btn btn-lg btn-primary" href="index.jsp" role="button">Retour a la page d'Accueil</a>
      </div>
    </div>
